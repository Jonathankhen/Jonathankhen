...
<ul>
  ...
  <li><a href="https://github.com/Jonathankhen/Nearest-Neighbor-Algorithm-Based-Parcel-Routing">Python Nearest Neighbor Algorithm-Based Parcel Routing</a> - This project implements a package routing program using the nearest neighbor algorithm to optimize delivery routes. It includes a hash table for efficient package management and a real-time interface for status updates.</li>
    <li><a href="https://github.com/Jonathankhen/Travel-Booking-System-Angular-Frontend-Spring-Boot-Backend-and-MySQL-Database">Travel Booking System</a> - A Minimal Viable Product (MVP) for a travel booking system with an Angular frontend and a Spring Boot backend for API services. A MySQL database is used for secure data storage. The system allows users to select vacation packages and excursions, with features for customer management and checkout processes.</li>
